...
/* 
 Did not use SafeMath as current @openzeppelin/contracts uses ^0.8.0 Solidity version Contracts will be compiled with @eth-optimism/solc on Optimism on version 0.7.6
 Code for learning purposes only to deploy to Optimistic may not be underflow/overflow safe
 If needed find and Install specific @openzeppelin/contracts@.x.x.x that supports ^0.7.6
*/
