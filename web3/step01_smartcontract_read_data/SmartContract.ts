...
export class SmartContract {
    ...
    public constructor(contractAddress: string = SmartContract.DAI_ADDRESS, abi: string = SmartContract.DAI_ABI) {
        ...
        this.abi = abi;
        this.web3 = new Web3("https://mainnet.infura.io/v3/your_account_number");
